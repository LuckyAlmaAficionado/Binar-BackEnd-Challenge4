...
CREATE TABLE `booking` (
  ...
  KEY `fk_show_id` (`ShowID`),
  KEY `fk_user_id` (`UserID`),
  CONSTRAINT `fk_show_id` FOREIGN KEY (`ShowID`) REFERENCES `show` (`ShowID`),
...
CREATE TABLE `cinema` (
  ...
  CONSTRAINT `fk_city_id` FOREIGN KEY (`CityID`) REFERENCES `city` (`CityID`)
...
CREATE TABLE `cinema_hall` (
  ...
  KEY `fk_cinema_id` (`CinemaID`),
  CONSTRAINT `fk_cinema_id` FOREIGN KEY (`CinemaID`) REFERENCES `cinema` (`CinemaID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cinema_seat` (
  ...
  KEY `fk_cinema_hall_id_cinema_seat` (`CinemaHallID`),
  CONSTRAINT `fk_cinema_hall_id_cinema_seat` FOREIGN KEY (`CinemaHallID`) REFERENCES `cinema_hall` (`CinemaHallID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment` (
  ...
  `RemoteTransactionID` int DEFAULT NULL,
...
CREATE TABLE `show` (
  ...
  PRIMARY KEY (`ShowID`),
  KEY `fk_cinema_hall_id` (`CinemaHallID`),
  KEY `fk_movie_id` (`MovieID`),
  CONSTRAINT `fk_cinema_hall_id` FOREIGN KEY (`CinemaHallID`) REFERENCES `cinema_hall` (`CinemaHallID`),
  CONSTRAINT `fk_movie_id` FOREIGN KEY (`MovieID`) REFERENCES `movie` (`MovieID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-03 13:55:22
